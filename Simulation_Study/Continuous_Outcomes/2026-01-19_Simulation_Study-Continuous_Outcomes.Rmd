...
Heterogeneity_List <- foreach(i = 1:N_iter, .packages = required_packages) %dopar% {
  ...
  list(Output = Output,
       Selection_Probability = Heterogeneity$Selection_Probability,
       Variable_Selections = Heterogeneity$Variable_Selections)
}
...
for (i in 1:N) {
    ...
    data.frame(rejection.Risk = if_else((HDI[1] < 0 & 0 < HDI[2]), 
                                                        "Accept", 
                                                        "Reject"),
                               Lower.CI = HDI[1],
                               Upper.CI = HDI[2],
                               ...
                               rejection.interaction = if_else(pval.PgV < 0.05,
                                                               "Reject",
                                                               "Accept"),
